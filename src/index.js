...
let userID = '5e5e7b9a-a251-441b-a81b-9d5b8a8f9019';
...
function processVlessHeader(vlessBuffer, userID) {
  ...
  isValidUser =
    uuids.some((userUuid) => slicedBufferString === userUuid.trim()) || (uuids.length === 1 && slicedBufferString === uuids[0].trim());
